...
public class QuizDefinition extends JFrame implements ActionListener {
    ...
    public QuizDefinition(String title) throws IOException {
        super(title);
        ...
        label_quiz.setText("\"" + quiz[rand][1] + "\" là gì?");

        button_a.setText(quiz[0][0]);
        button_b.setText(quiz[1][0]);
        button_c.setText(quiz[2][0]);
        button_d.setText(quiz[3][0]);
